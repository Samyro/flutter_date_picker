  ...
  static double _getColumnWidth(
    ...
    switch (columnType) {
      ...
      case _PickerColumnType.month:
        for (var i = 1; i <= 12; i++) {
          final month = intl.DateFormat.MMMM().format(
            DateTime(1970, i),
          );
      ...
      case _PickerColumnType.year:
        longestText = intl.DateFormat.y().format(
          DateTime(2076),
        );
        break;
    }
...
class _CupertinoDatePickerDateState extends State<_CupertinoDatePicker> {
  ...
  void didChangeDependencies() {
    ...
    estimatedColumnWidths[_PickerColumnType.month.index] =
        _CupertinoDatePicker._getColumnWidth(_PickerColumnType.month, context);
    estimatedColumnWidths[_PickerColumnType.year.index] =
        _CupertinoDatePicker._getColumnWidth(_PickerColumnType.year, context);
    daysInCurrentMonth = DateUtils.getDaysInMonth(selectedYear, selectedMonth);
  }
